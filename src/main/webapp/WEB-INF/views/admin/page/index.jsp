...
<html lang="en">
    <head>
        ...
        <title>PET SHOP Dashboard - SB Admin</title>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <canvas id="myAreaChart" width="636" height="254" style="display: block; height: 127px; width: 318px;" class="chartjs-render-monitor"></canvas>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">

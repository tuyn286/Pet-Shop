                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            <a href="<c:url value='/user'/>" class="nav-item nav-link active">Home</a>
                            <a href="<c:url value='/user/about'/>" class="nav-item nav-link">About</a>
                            <a href="<c:url value='/user/service'/>" class="nav-item nav-link">Service</a>
                            <a href="<c:url value='/user/product'/>" class="nav-item nav-link">Product</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                                <div class="dropdown-menu m-0">
                                    <a href="<c:url value='/user/price'/>" class="dropdown-item">Pricing Plan</a>
                                    <a href="<c:url value='/user/team'/>" class="dropdown-item">The Team</a>
                                    <a href="<c:url value='/user/testimonial'/>" class="dropdown-item">Testimonial</a>
                                    <a href="<c:url value='/user/blog'/>" class="dropdown-item">Blog Grid</a>
                                    <a href="<c:url value='/user/blog-detail'/>" class="dropdown-item">Blog Detail</a>
                                </div>
                            </div>
                            <a href="<c:url value='/user/contact'/>"
                    ...
                    <div class="container py-5">
                        <div class="row justify-content-start">
                            <div class="col-lg-8 text-center text-lg-start">
                                ...
                                <p class="fs-4 text-white mb-lg-4">Dolore tempor clita lorem rebum kasd eirmod dolore
                                    diam eos kasd. Kasd clita ea justo est sed kasd erat clita sea</p>
                                <div
                            ...
                            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute w-100 h-100 rounded"
                                        src="<c:url value='/assets/img/about.jpg'/>" style="object-fit: cover;">
                                </div>
                            </div>
                            <div class="col-lg-7">
                        ...
                        <div class="row g-5">
                                ...
                                <div class="blog-item">
                                    <div class="row g-0 bg-light overflow-hidden">
                                        <div class="col-12 col-sm-5 h-100">
                                            <img class="img-fluid h-100" src="img/blog-1.jpg"
                                                style="object-fit: cover;">
                                        </div>
                                        <div class="col-12 col-sm-7 h-100 d-flex flex-column justify-content-center">
                                            <div class="p-4">
                                                <div class="d-flex mb-3">
                                                    <small class="me-3"><i class="bi bi-bookmarks me-2"></i>Web
                                                        Design</small>
                                                    <small><i class="bi bi-calendar-date me-2"></i>01 Jan, 2045</small>
                                                </div>
                                                <h5 class="text-uppercase mb-3">Dolor sit magna rebum clita rebum dolor
                                                </h5>
                                                <p>Ipsum sed lorem amet dolor amet duo ipsum amet et dolore est stet
                                                    tempor eos dolor</p>
                                                <a class="text-primary text-uppercase" href="">Read More<i
                                                        class="bi bi-chevron-right"></i></a>
                                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="blog-item">
                                    <div class="row g-0 bg-light overflow-hidden">
                                        <div class="col-12 col-sm-5 h-100">
                                            <img class="img-fluid h-100" src="img/blog-2.jpg"
                                                style="object-fit: cover;">
                                        </div>
                                        <div class="col-12 col-sm-7 h-100 d-flex flex-column justify-content-center">
                                            <div class="p-4">
